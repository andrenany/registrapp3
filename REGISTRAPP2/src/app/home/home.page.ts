...
export class HomePage implements OnInit {
  ...
  async loadAsistencias() {
    try {
      const totalAsistencias = this.asisTotales
  ...
  actualizarProgreso() {
    this.progreso = this.asisRegistradas / this.asisTotales;
    console.log(this.asisRegistradas, this.asisTotales, this.progreso);
  }
  ...
  async registrarAsistencia() {
    try {
      ...
      await this.loadAsistencias();
      this.actualizarProgreso();   // Calcula el progreso
      console.log(this.asisRegistradas, this.asisTotales, this.progreso);
  ...
  //codigos que se utilizaran cuando se conecte a una base de datos con un hostin
